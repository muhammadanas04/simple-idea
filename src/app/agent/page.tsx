      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 py-8 space-y-6">
        ...
        <div className="flex gap-2 p-1.5 bg-white rounded-2xl shadow-soft max-w-md mx-auto sm:mx-0">
          <button
            ...
            className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all focus:outline-none cursor-pointer text-center ${activeTab === "tester"
          ...
          <button
            ...
            className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all focus:outline-none cursor-pointer text-center ${activeTab === "prompt"
                ? "bg-navy-dark text-white shadow-sm"
                : "bg-transparent text-navy-text hover:bg-lavender-bg/40"
              }`}
          >
